...
export default class Vector3 implements Vector<Vec3> {
  ...
  *[Symbol.iterator](): Iterator<number> {
   ...
   * @returns {this}
   */
  public fromSphericalCoords(phi: number, theta: number, radius?: number): this {
    const [x, y, z] = Vector3.fromSphericalCoords(phi, theta, radius);
    this.x = x;
    this.y = y;
    this.z = z;
    return this;
   ...
   * @returns {this}
   */
  public fromCylindricalCoords(theta: number, y: number, radius?: number): this {
    const [x, _, z] = Vector3.fromCylindricalCoords(theta, y, radius);
    this.x = x;
    this.y = y;
    this.z = z;
    return this;
